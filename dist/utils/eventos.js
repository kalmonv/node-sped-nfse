...
const urlEventos = {
    gov: {
        homologacao: {
            ...
            NFSeConsulta: "https://sefin.producaorestrita.nfse.gov.br/sefinnacional/nfse/{chaveAcesso}",
            NFSeCancelar: "https://sefin.producaorestrita.nfse.gov.br/sefinnacional/nfse/{chaveAcesso}/eventos", // POST (registro de evento)
            NFSeConsultaEvento: "https://sefin.producaorestrita.nfse.gov.br/sefinnacional/nfse/{chaveAcesso}/eventos", // GET
            DPSConsulta: "https://sefin.producaorestrita.nfse.gov.br/sefinnacional/dps/{id}", // GET/HEAD
            DANFSe: "https://sefin.producaorestrita.nfse.gov.br/sefinnacional/danfse/{chaveAcesso}",
            ...
            ParamAliquota: "https://sefin.producaorestrita.nfse.gov.br/sefinnacional/parametros_municipais/{codigoMunicipio}/{codigoServico}/{competencia}/aliquota",
            ParamHistoricoAliquotas: "https://sefin.producaorestrita.nfse.gov.br/sefinnacional/parametros_municipais/{codigoMunicipio}/{codigoServico}/historicoaliquotas",
            ParamRetencoes: "https://sefin.producaorestrita.nfse.gov.br/sefinnacional/parametros_municipais/{codigoMunicipio}/{competencia}/retencoes",
            ParamRegimesEspeciais: "https://sefin.producaorestrita.nfse.gov.br/sefinnacional/parametros_municipais/{codigoMunicipio}/{codigoServico}/{competencia}/regimes_especiais",
            ...
            DFeDistribNSU: "https://adn.producaorestrita.nfse.gov.br/contribuinte/DFe/{NSU}",
            DFeEventosPorChave: "https://adn.producaorestrita.nfse.gov.br/contribuinte/NFSe/{chaveAcesso}/Eventos"
        },
        producao: {
            // SEFIN (Produção) — unitário e consultas oficiais
            NFSeEnvio: "https://sefin.nfse.gov.br/sefinnacional/nfse",
            NFSeConsulta: "https://sefin.nfse.gov.br/sefinnacional/nfse/{chaveAcesso}",
            NFSeCancelar: "https://sefin.nfse.gov.br/sefinnacional/nfse/{chaveAcesso}/eventos", // POST
            NFSeConsultaEvento: "https://sefin.nfse.gov.br/sefinnacional/nfse/{chaveAcesso}/eventos", // GET
            DPSConsulta: "https://sefin.nfse.gov.br/sefinnacional/dps/{id}",
            DANFSe: "https://sefin.nfse.gov.br/sefinnacional/danfse/{chaveAcesso}",
            // Parâmetros Municipais (produção)
            ParamConvenio: "https://sefin.nfse.gov.br/sefinnacional/parametros_municipais/{codigoMunicipio}/convenio",
            ...
            // ADN (Produção) — lote e distribuição DF-e
            LoteEnvio: "https://adn.nfse.gov.br/dfe",
            LoteConsulta: "https://adn.nfse.gov.br/dfe/{nsuRecepcao}",
            DFeDistribNSU: "https://adn.nfse.gov.br/contribuinte/DFe/{NSU}",
            DFeEventosPorChave: "https://adn.nfse.gov.br/contribuinte/NFSe/{chaveAcesso}/Eventos"
        }
    }
};
const urlEventos400 = {
